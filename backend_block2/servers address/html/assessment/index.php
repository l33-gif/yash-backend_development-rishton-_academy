        ...
        <div class="main">
            ...
            <div class="searchform-container">
                <form class="searchform" action="search.php" method="POST">
                    <button type="submit" name="searchType" value="pupil">View Pupils</button>
                    <button type="submit" name="searchType" value="teacher">View Teachers</button>
                    <button type="submit" name="searchType" value="assistantTeacher">View Assistant Teachers</button>
                </form>
            </div>
        </div>
    </div>
