...
<head>
    ...
    <title>Assistant Teachers</title>
        ...
        <div class="main">
            ...
            <div class="assistant-section">
                <div class="assistant-card">
                    <h2>Update Assistant Teacher</h2>
                    <button onclick="location.href='update_assist_teacher.php'">Update</button>
                    <!-- Connect to update form here -->
                </div>
                <div class="assistant-card">
                    <h2>Insert Assistant Teacher</h2>
                    <button onclick="location.href='add_assist_teacher.php'">Insert</button>
                    <!-- Connect to insert form here -->
                </div>
                <div class="assistant-card">
                    <h2>Delete Assistant Teacher</h2>
                    <button onclick="location.href='delete_assist_tecaher.php'">Delete</button>
